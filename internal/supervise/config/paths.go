...
// inject errors for the os.UserHomeDir error path. $HOME is non-secret.
//
...
// internal/config helper — duplicated rather than shared (tiny
// duplication is preferred over thin abstractions until a third caller
// emerges).
