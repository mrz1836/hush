...
// plaintext, or key byte ever appears in any error message.
var (
	...
	// Wrong key and tampered envelope share this sentinel by design.
	...
	// public key is nil, has a nil curve, or is not on secp256k1.
