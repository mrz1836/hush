...
// stand-in path until local key derivation lands
...
// The returned bytes are what the client signs
...
// signRevokePayload signs the canonical bytes via sign.Sign and
